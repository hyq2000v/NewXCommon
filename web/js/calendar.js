...
function Calendar(p_item, p_WinCal, p_month, p_year, p_format) 
{
	...
	if (eval("document." + p_item) == null) p_item = "forms[0]." + p_item;
...
Calendar.prototype.show = function() {
	...
	// Setup the page...
	this.wwrite("<html>");
	this.wwrite("<style type='text/css'><!--TABLE {FONT-SIZE: 9pt}");
	this.wwrite(" TD {FONT-SIZE: 9pt}--></style>");
	
	this.wwrite("<head><title>日历</title>");
	this.wwrite("</head>");

	this.wwrite("<body background='../images/background.jpg'" + 
		"link=\"" + this.gLinkColor + "\" " + 
		"vlink=\"" + this.gLinkColor + "\" " +
		"alink=\"" + this.gLinkColor + "\" " +
		"text=\"" + this.gTextColor + "\">");
	this.wwriteA("<center><B>");
	...
	this.wwrite("<TABLE WIDTH='76%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#e0e0e0'><font size='2'<TR><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" +
		");" +
		"\">上年<\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
...
Calendar.prototype.cal_header = function() {
	...
	vCode = vCode + "<TR>";
	vCode = vCode + "<TD WIDTH='14%'><FONT  FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>日</B></FONT></TD>";
...
*/
	...
	p_year = new String(gNow.getFullYear().toString());
	  p_format=format;
	vWinCal = window.open("", "", 
		"width=210,height=210,status=no,resizable=no,top=260,left=150,location=no,menubar=no,titlebar=no");
	//vWinCal = openIt("","Calendar",250,220);
	vWinCal.opener = self;
	ggWinCal = vWinCal;
...
function show_yearly_calendar(p_item, p_year, p_format) {
	...
	var vWinCal = window.open("", "日历", "scrollbars=yes");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
